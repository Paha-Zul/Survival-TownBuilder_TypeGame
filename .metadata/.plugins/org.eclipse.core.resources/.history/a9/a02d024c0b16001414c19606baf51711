...
public class Inventory extends Component {
	 ...
	 */
	public Inventory(Entity owner, String name, int type, boolean active, int size, 
			int maxNumItems) {
	 ...
	 */
	public Inventory(Entity owner, int size, int maxNumItems, boolean infiniteSize, boolean infiniteQuantity) {
	 ...
	 * @param infiniteQuantity If the Inventory is infinite in Item quantity.
	 */
	public Inventory(Entity owner, int maxNumItems, boolean infiniteSize, boolean infiniteQuantity) {
		this(owner, 0, maxNumItems, infiniteSize, infiniteQuantity);
		
	}
	
	public Inventory(Entity owner, boolean infiniteSize, boolean infiniteQuantity) {
