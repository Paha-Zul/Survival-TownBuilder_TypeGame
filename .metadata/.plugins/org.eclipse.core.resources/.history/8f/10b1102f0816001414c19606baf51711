...
public class TransferItem extends Job {
	 ...
	 * @param quantity
	 */
	public TransferItem(JobGroup group, String name, int jobType, InventoryScala<?> fromInv,
			InventoryScala<?> toInv, Item item, int quantity, boolean transferAll) {
	 ...
	 */
	public TransferItem(JobGroup group, InventoryScala<?> fromInv, InventoryScala<?> toInv, Item item, int quantity){
	 ...
	 * @param item The Item to transfer.
	 */
	public TransferItem(JobGroup group, InventoryScala<?> fromInv, InventoryScala<?> toInv, Item item, boolean transferAll){
